...
bExcel = false;
  ...
  project: Project;
  document: Document;
  constructor(private prjService: VictorServiceService, private router: Router) {
      this.project = new Project();
      this.document = new Document();
      //this.document.dFile ='sd';
      //this.document.name = 'zfg';
        this.loading=true;
        this.prjService.get_projects_of_company(localStorage.getItem('user_name')).subscribe((data: Project[])=>{
        this.projects = data;
        this.loading=false;
