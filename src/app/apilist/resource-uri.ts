export  class ResourceURI {
     private static host = 'http://192.168.1.41:8000';
    //private static host = 'http://159.65.157.21:8000';
...
///api/account/LeadSource/Validate?startDate=09/11/2018&endDate=11/11/2018&CompanyId=46
    ...
    public static gDocument = ResourceURI.host + '/api/Account/documents/project/'; 

    public static pUpload = ResourceURI.host + '/api/Account/documents/create';
  ...
  public static upadteLeads = ResourceURI.host + '/api/Lead/';

  //http://192.168.1.41:8000/api/Account/users/projectid/1
  public static gUsersOfProject = ResourceURI.host + '/api/Account/users/projectid/';
...
//Leads?userName=aarif&statusID=1
  public static otherLeads = ResourceURI.host + '/api/Leads?userName='

 // http://192.168.1.33:8000/api/Account/Reporting/1/1
 public static gdownloadReport = ResourceURI.host + '/api/Account/Reporting/';

 //http://192.168.1.41:8000/api/Agents?companyid=1
 public static getAgents = ResourceURI.host + '/api/Agents?companyid=';
//api/Ask/quotation
 public static pAskQuotation = ResourceURI.host + '/api/Ask/quotation';
 //api/Ask/quotation?agentid=
 public static gQuotationOrder = ResourceURI.host + '/api/Ask/quotation?agentid=';


 //gOrderList
 public static gOrderList = ResourceURI.host + '/api/Ask/quotation?username=';

 //http://192.168.1.41:8000/api/Agents?companyid=1
 public static gAgents = ResourceURI.host + '/api/Agents?companyid=';
 public static pAgent = ResourceURI.host + '/api/Agents';
